    ...
    <div className="services__container container grid">
            ...
            <ul className="services__modal-services grid">
              <li className="services__modal-service">
                ...
                <p className="services__modal-info">
                  I work with more platmform on backend side
                </p>
              </li>
              ...
              <li className="services__modal-service">
                ...
                <p className="services__modal-info">
                 I am familiar mongo, sequelize and mysql databases
                </p>
              </li>
              ...
              <li className="services__modal-service">
                ...
                <p className="services__modal-info">
                  I work with mostly backend languaes
                </p>
              </li>
      ...
      <div className="services__content">
        ...
        <div className={toggleState === 2 ? "services__modal active-modal" : "services__modal"}>
          <div className="services__modal-content">
            ...
            <p className="services__modal-description">Service with more than one year of experience. Providing quality work to clients</p>
            <ul className="services__modal-services grid">
              <li className="services__modal-service">
                <i className="uil uil-check-circle services__modal-icon">
                </i>
              ...
              <li className="services__modal-service">
                ...
                <p className="services__modal-info">
                 Design and mockups f products for your companies
                </p>
              </li>
            </ul>
          </div>
      ...
      <div className="services__content">
        <div >
          ...
          <h3 className="services__title">Photographer</h3>
        </div>
        ...
        <div className={toggleState === 3 ? "services__modal active-modal" : "services__modal"}>
          <div className="services__modal-content">
            <i onClick={() => toggleTab(0)} className="uil uil-times services__modal-close"></i>
            <h3 className="services__modal-title">Photography</h3>
            ...
            <ul className="services__modal-services grid">
              ...
              <li className="services__modal-service">
                ...
                <p className="services__modal-info">
                  I do best shooting in ceremonies
                </p>
              </li>
              ...
              <li className="services__modal-service">
                ...
                <p className="services__modal-info">
                  I can make you invitations and business cards
                </p>
              </li>
