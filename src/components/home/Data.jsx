...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Alain Honore
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                >
                 ...
                 <h3 className="home__subtitle">Video Editor</h3>

                 <p className="home__description">
                    I am Video editor and websites developer located in Kigali and I am passionate to my work.
                 </p>
